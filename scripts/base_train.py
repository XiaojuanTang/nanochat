...
use_gradient_checkpointing = False # use gradient checkpointing to save memory
use_liger_kernels = False # use Liger fused linear+cross-entropy (requires liger-kernel)
# Evaluation
